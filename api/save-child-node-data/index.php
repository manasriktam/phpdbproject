...
try {
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $parentuid = $_POST["parentuid"];
        $nodeuid = $_POST["nodeuid"];
        $ischildnode = $_POST["ischildnode"];
        $isaireply = $_POST["isaireply"];
        $nodemessage = $_POST["nodemessage"];
        ...
        $insertQuery = "INSERT INTO childnodestable (sessionuid,useruid,parentuid,nodeuid,ischildnode,isaireply,nodemessage) VALUES ('$sessionuid','$useruid','$parentuid','$nodeuid','$ischildnode','$isaireply','$nodemessage')";
        $db->exec($insertQuery);
